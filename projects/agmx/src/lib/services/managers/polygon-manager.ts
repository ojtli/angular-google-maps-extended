...
import {
  AgmPolygon,
  PathChangePolygonPathEvent,
  PathCollectionChangePolygonPathEvent,
  PolygonPathEvent
} from '../../directives/polygon';
...
export class PolygonManager {
  ...
  getPath(agmPolygon: AgmPolygon): Promise<Array<google.maps.LatLng>> {
    return this._polygons.get(agmPolygon)
      .then((polygon) => polygon.getPath().getArray());
  }

  getPaths(agmPolygon: AgmPolygon): Promise<Array<Array<google.maps.LatLng>>> {
    return this._polygons.get(agmPolygon)
